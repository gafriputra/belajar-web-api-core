        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .HasConstraintName("FK__Book__pub_id__22AA2996");
            });
            ...
            modelBuilder.Entity<BookAuthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Author)
                    ...
                    .HasConstraintName("FK__BookAutho__autho__239E4DCF");

                entity.HasOne(d => d.Book)
                    .WithMany(p => p.BookAuthors)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__BookAutho__book___24927208");
            });
            ...
            modelBuilder.Entity<RefreshToken>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasConstraintName("FK__RefreshTo__user___25869641");
            });
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__Sale__book_id__267ABA7A");

                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Sales)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK__Sale__store_id__276EDEB3");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.Job)
                    ...
                    .HasConstraintName("FK__User__job_id__2C3393D0");
